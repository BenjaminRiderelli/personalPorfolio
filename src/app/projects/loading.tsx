...
const Loading = () => {
  return (
    <section
      className={`flex flex-col h-full w-full border-b-2 border-light-text-color dark:border-dark-text-color `}
    >
      ...
      <div
        className={`flex flex-col w-full min-h-screen lg:w-1/2 bg-light-bg-color dark:bg-dark-bg-color border-light-text-color dark:border-dark-text-color`}
      >
